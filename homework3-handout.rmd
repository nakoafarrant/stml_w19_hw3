...
# what if you calculate kmeans first and then you set membership rows based on the kmeans and the membership columns based on the hierarchical clustering
